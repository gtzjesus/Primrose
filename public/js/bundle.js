...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(productId) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51Kame0BSH4fQuSRgSPPDtkXHfXaUGDa8JDCvIRKSj6fuhSC1aCf2NMPVKGLnEp3rz0nFTedw0ggfpmx2JViwTVs8001nH4KD6r');
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)("/api/bookings/checkout-session/".concat(productId));
